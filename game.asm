...
str_6 db "=== LUCKY BONUS: Achievement unlocked! ===", 0
...
str_178 db "Enter choice (1-4): ", 0
scanf_fmt_179 db "%d", 0
str_180 db "=== GUESS THE NUMBER MINIGAME ===", 0
str_181 db "Guess a number between 1 and 5!", 0
str_182 db "Win big rewards if you guess correctly!", 0
str_183 db "Enter your guess (1-5): ", 0
scanf_fmt_184 db "%d", 0
str_185 db "Congratulations! You guessed it!", 0
str_186 db "You won %d of each resource!", 0
str_187 db "Wrong! The number was %d", 0
str_188 db "Better luck next time!", 0
str_189 db "=== CARD GUESSING GAME ===", 0
str_190 db "Guess if the next card is HIGHER or LOWER!", 0
str_191 db "Win streak increases rewards!", 0
str_192 db "Cards are numbered 1-13", 0
str_193 db "First card: %d", 0
str_194 db "Round %d of 5", 0
str_195 db "Current streak: %d", 0
str_196 db "========================", 0
str_197 db "Current card: %d", 0
str_198 db "Guess next card:", 0
str_199 db "1 = HIGHER", 0
str_200 db " 2 = LOWER", 0
scanf_fmt_201 db "%d", 0
str_202 db "Next card: %d", 0
str_203 db "Same card! No change to streak.", 0
str_204 db "Correct! Streak: %d", 0
str_205 db "Wrong! Streak broken.", 0
str_206 db "Continue to next round?", 0
str_207 db "1 = YES", 0
str_208 db " 2 = NO (Cash out now)", 0
scanf_fmt_209 db "%d", 0
str_210 db "=== CARD GAME RESULTS ===", 0
str_211 db "Maximum Streak: %d", 0
str_212 db "Reward Multiplier: x%d", 0
str_213 db "No winning streaks this game.", 0
str_214 db "Try again for better luck!", 0
str_215 db "=== MATH QUIZ CHALLENGE ===", 0
str_216 db "Solve math problems for bonuses!", 0
str_217 db "Difficulty increases with your level!", 0
str_218 db "--- Question %d of %d ---", 0
str_219 db "What is %d + %d?", 0
str_220 db "What is %d - %d?", 0
str_221 db "What is %d * %d?", 0
str_222 db "What is %d / %d?", 0
str_223 db "Enter your answer: ", 0
scanf_fmt_224 db "%d", 0
str_225 db "Correct! +1 point", 0
str_226 db "Wrong! The answer was %d", 0
str_227 db "Quiz Complete! Score: %d/%d", 0
str_228 db "Quiz Complete! Score: 0/%d", 0
str_229 db "Study up and try again!", 0
str_230 db "=== ROCK PAPER SCISSORS ===", 0
str_231 db "Best of 3 rounds!", 0
str_232 db "1 = ROCK (beats scissors)", 0
str_233 db " 2 = PAPER (beats rock)", 0
str_234 db " 3 = SCISSORS (beats paper)", 0
str_235 db "Win all 3 rounds for maximum reward!", 0
str_236 db "===========================", 0
str_237 db "--- Round %d ---", 0
str_238 db "Choose: 1=Rock, 2=Paper, 3=Scissors", 0
str_239 db "Your choice: ", 0
scanf_fmt_240 db "%d", 0
str_241 db "You chose: ", 0
str_242 db "ROCK", 0
str_243 db "PAPER", 0
str_244 db "SCISSORS", 0
str_245 db "Bot chose: ", 0
str_246 db "It's a TIE!", 0
str_247 db "Replaying round...", 0
str_248 db "You WIN this round!", 0
str_249 db "Bot WINS this round!", 0
str_250 db "Score: You %d - %d Bot", 0
str_251 db "=== ROCK PAPER SCISSORS RESULTS ===", 0
str_252 db "Final Score: You %d - %d Bot", 0
str_253 db "PERFECT VICTORY! 3-0 SWEEP!", 0
str_254 db "JACKPOT! You won %d of each resource!", 0
str_255 db "VICTORY! You beat the bot!", 0
str_256 db "Close match! You won!", 0
str_257 db "DRAW! No winner this time.", 0
str_258 db "Consolation prize: %d of each resource", 0
str_259 db "DEFEAT! The bot was too strong!", 0
str_260 db "Participation reward: %d of each resource", 0
str_261 db "+%d wood", 0
str_262 db "+%d stone", 0
str_263 db "+%d gold", 0
str_264 db "Daily reward collected!", 0
str_265 db "Daily reward already collected.", 0
str_266 db "No boss right now.", 0
str_267 db "You deal %d damage!", 0
str_268 db "Boss defeated! Massive resource drop!", 0
str_269 db "Boss HP: %d", 0
str_270 db "=== MARKETPLACE ===", 0
str_271 db "Exchange rates fluctuate! (Refreshes when you leave)", 0
str_272 db "Your Resources:", 0
str_273 db "Wood: %d | Stone: %d | Gold: %d", 0
str_274 db "1. Wood -> Stone (rate: 1:%d)", 0
str_275 db "   Exchange %d wood for %d stone", 0
str_276 db "2. Stone -> Gold (rate: 1:%d)", 0
str_277 db "   Exchange %d stone for %d gold", 0
str_278 db "3. Gold -> Wood (rate: 1:%d)", 0
str_279 db "   Exchange %d gold for %d wood", 0
str_280 db "4. Bulk Exchange (10x amount)", 0
str_281 db "   Requires 10x resources but better rate!", 0
str_282 db "5. Speculate (Risk/Reward)", 0
str_283 db "   Bet resources on market movement", 0
str_284 db "6. Refresh Rates (cost: 10 gold)", 0
str_285 db "   Get new exchange rates", 0
str_286 db "7. Exit Marketplace", 0
str_287 db "Enter choice (1-7): ", 0
scanf_fmt_288 db "%d", 0
str_289 db "Traded %d wood for %d stone!", 0
str_290 db "Not enough wood! Need %d, have %d", 0
str_291 db "Traded %d stone for %d gold!", 0
str_292 db "Not enough stone! Need %d, have %d", 0
str_293 db "Traded %d gold for %d wood!", 0
str_294 db "Not enough gold! Need %d, have %d", 0
str_295 db "=== BULK EXCHANGE ===", 0
str_296 db "Exchange 10x resources for bonus rate!", 0
str_297 db "1. Wood -> Stone (rate: 1:%d + %d bonus)", 0
str_298 db "2. Stone -> Gold (rate: 1:%d + %d bonus)", 0
str_299 db "3. Gold -> Wood (rate: 1:%d + %d bonus)", 0
str_300 db "4. Back", 0
str_301 db "Enter bulk choice: ", 0
scanf_fmt_302 db "%d", 0
str_303 db "(Bonus rate: 1:%d)", 0
str_304 db "=== MARKET SPECULATION ===", 0
str_305 db "Bet resources on market movement!", 0
str_306 db "Choose resource to bet:", 0
str_307 db "1. Bet on WOOD price increase", 0
str_308 db "   (Win: 2x wood, Lose: lose bet)", 0
str_309 db "2. Bet on STONE price increase", 0
str_310 db "   (Win: 2x stone, Lose: lose bet)", 0
str_311 db "3. Bet on GOLD price increase", 0
str_312 db "   (Win: 2x gold, Lose: lose bet)", 0
str_313 db "Enter speculation choice: ", 0
scanf_fmt_314 db "%d", 0
str_315 db "Enter amount to bet (min 10): ", 0
scanf_fmt_316 db "%d", 0
str_317 db "=== MARKET MOVES IN YOUR FAVOR! ===", 0
str_318 db "Wood price soared! You win %d wood!", 0
str_319 db "Stone price soared! You win %d stone!", 0
str_320 db "Gold price soared! You win %d gold!", 0
str_321 db "=== MARKET CRASH! ===", 0
str_322 db "Wood price crashed! Lost %d wood!", 0
str_323 db "Stone price crashed! Lost %d stone!", 0
str_324 db "Gold price crashed! Lost %d gold!", 0
str_325 db "Not enough resources for that bet!", 0
str_326 db "Market rates refreshed! (-10 gold)", 0
str_327 db "Need 10 gold to refresh rates!", 0
str_328 db "Leaving marketplace...", 0
str_329 db "Exiting game...", 0
str_330 db "Total Resources: %d", 0
str_331 db "Turns Played: %d", 0
str_332 db "Collections Made: %d", 0
str_333 db "=== ACHIEVEMENT UNLOCKED: Resource Baron! (100+ total resources) ===", 0
str_334 db "=== ACHIEVEMENT UNLOCKED: Wealthy Magnate! (1,000+ total resources) ===", 0
str_335 db "=== ACHIEVEMENT UNLOCKED: Resource Millionaire! (10,000+ total resources) ===", 0
str_336 db "=== ACHIEVEMENT UNLOCKED: Lumberjack! (50+ wood) ===", 0
str_337 db "=== ACHIEVEMENT UNLOCKED: Quarry King! (50+ stone) ===", 0
str_338 db "=== ACHIEVEMENT UNLOCKED: Gold Digger! (50+ gold) ===", 0
str_339 db "=== ACHIEVEMENT UNLOCKED: Wood Tycoon! (500+ wood) ===", 0
str_340 db "=== ACHIEVEMENT UNLOCKED: Stone Tycoon! (500+ stone) ===", 0
str_341 db "=== ACHIEVEMENT UNLOCKED: Gold Tycoon! (500+ gold) ===", 0
str_342 db "=== ACHIEVEMENT UNLOCKED: Minigame Master! (10 minigame wins) ===", 0
str_343 db "=== ACHIEVEMENT UNLOCKED: Event Explorer! (20 random events) ===", 0
str_344 db "=== ACHIEVEMENT UNLOCKED: Turn Veteran! (100 turns played) ===", 0
str_345 db "=== ACHIEVEMENT UNLOCKED: Collector Addict! (200 collections made) ===", 0
str_346 db "=== ACHIEVEMENT UNLOCKED: Iron Fist! (Level 100) ===", 0
str_347 db "=== ACHIEVEMENT UNLOCKED: Collector Pro! (500 collections) ===", 0
str_348 db "=== ACHIEVEMENT UNLOCKED: Ultra Rich! (100,000+ total resources) ===", 0
str_349 db "=== ACHIEVEMENT UNLOCKED: Grinder! (500 turns played) ===", 0
str_350 db "=== ACHIEVEMENT UNLOCKED: Hoarder! (5,000+ of a resource) ===", 0
str_351 db "=== ACHIEVEMENT UNLOCKED: Unstoppable! (25 minigame wins) ===", 0
str_352 db "=== ACHIEVEMENT UNLOCKED: Event Legend! (100 random events) ===", 0
str_353 db "=== ACHIEVEMENT UNLOCKED: Jackpot! (15 minigame wins) ===", 0
str_354 db "=== ACHIEVEMENT UNLOCKED: Dedicated! (1,000 turns played) ===", 0
str_355 db "=== ACHIEVEMENT UNLOCKED: Maxed Out! (Level 200) ===", 0
str_356 db "=== ACHIEVEMENT UNLOCKED: Trader! (10 trades made) ===", 0
str_357 db "=== ACHIEVEMENT UNLOCKED: Speculator! (5 market bets made) ===", 0
str_358 db "=== ACHIEVEMENT UNLOCKED: Market Tycoon! (50 trades made) ===", 0
cmd_359 db "cls", 0
str_360 db "Turn: %d", 0
str_361 db "Auto Collect Rate: %d", 0
str_362 db "Prestige: Level %d (x%d bonus)", 0
str_363 db "A wild RESOURCE GOLEM appears!", 0
...
var_rand_state_188 resd 1
var_goldexchangerate resd 1
var_rand_state_189 resd 1
...
if_then_5:
    ...
    mov eax, 2
    mov dword [var_multiplier], eax
    cmp dword [var_rand_state_6], 0
    jne rand_init_6
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_6], eax
rand_init_6:
    mov eax, dword [var_rand_state_6]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_6]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_6], eax
    mov dword [var_rand_state_6], eax
    mov ecx, 1
    mov ebx, 20
    sub ebx, ecx
    ...
    mov eax, edx
    add eax, ecx
    mov dword [var_luckychance], eax
    mov eax, dword [var_luckychance]
    mov ebx, 1
    cmp eax, ebx
    je if_then_7
    jmp if_else_7
...
if_end_10:
    ...
    jmp if_else_12
if_then_12:
    cmp dword [var_rand_state_13], 0
    jne rand_init_13
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_13], eax
rand_init_13:
    mov eax, dword [var_rand_state_13]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_13]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_13], eax
    mov dword [var_rand_state_13], eax
    mov ecx, 1
    mov ebx, 5
    sub ebx, ecx
...
if_then_39:
    ...
    mov eax, ebx
    mov dword [var_totalcollections], eax
    cmp dword [var_rand_state_40], 0
    jne rand_init_40
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_40], eax
rand_init_40:
    mov eax, dword [var_rand_state_40]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_40]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_40], eax
    mov dword [var_rand_state_40], eax
    mov ecx, 1
    mov ebx, 3
    sub ebx, ecx
...
if_then_123:
    ...
    call _printf
    add esp, 4
    cmp dword [var_rand_state_124], 0
    jne rand_init_124
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_124], eax
rand_init_124:
    mov eax, dword [var_rand_state_124]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_124]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_124], eax
    mov dword [var_rand_state_124], eax
    mov ecx, 1
    mov ebx, 5
    sub ebx, ecx
...
while_start_128:
    ...
    call _printf
    add esp, 4
    cmp dword [var_rand_state_129], 0
    jne rand_init_129
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_129], eax
rand_init_129:
    mov eax, dword [var_rand_state_129]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_129]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_129], eax
    mov dword [var_rand_state_129], eax
    mov ecx, 1
    mov ebx, 13
    sub ebx, ecx
...
rand_init_145:
    ...
    cmp dword [var_rand_state_146], 0
    jne rand_init_146
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_146], eax
rand_init_146:
    mov eax, dword [var_rand_state_146]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_146]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_146], eax
    mov dword [var_rand_state_146], eax
    mov ecx, 1
    mov ebx, dword [var_maxnumber]
    sub ebx, ecx
...
rand_init_147:
    ...
    jmp if_else_148
if_then_148:
    cmp dword [var_rand_state_149], 0
    jne rand_init_149
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_149], eax
rand_init_149:
    mov eax, dword [var_rand_state_149]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_149]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_149], eax
    mov dword [var_rand_state_149], eax
    mov ecx, 1
    mov ebx, 10
    sub ebx, ecx
...
if_else_159:
if_end_159:
    cmp dword [var_rand_state_160], 0
    jne rand_init_160
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_160], eax
rand_init_160:
    mov eax, dword [var_rand_state_160]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_160]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_160], eax
    mov dword [var_rand_state_160], eax
    mov ecx, 1
    mov ebx, 3
    sub ebx, ecx
...
rand_init_187:
    ...
    cmp dword [var_rand_state_188], 0
    jne rand_init_188
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_188], eax
rand_init_188:
    mov eax, dword [var_rand_state_188]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_188]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_188], eax
    mov dword [var_rand_state_188], eax
    mov ecx, 1
    mov ebx, 2
    sub ebx, ecx
    ...
    cmp dword [var_rand_state_189], 0
    jne rand_init_189
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_189], eax
rand_init_189:
    mov eax, dword [var_rand_state_189]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_189]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_189], eax
    mov dword [var_rand_state_189], eax
    mov ecx, 1
    mov ebx, 2
    sub ebx, ecx
...
if_then_201:
    ...
    cmp dword [var_rand_state_202], 0
    jne rand_init_202
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_202], eax
rand_init_202:
    mov eax, dword [var_rand_state_202]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_202]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_202], eax
    mov dword [var_rand_state_202], eax
    mov ecx, 1
    mov ebx, 3
    sub ebx, ecx
...
if_end_216:
    ...
    jmp if_else_218
if_then_218:
    cmp dword [var_rand_state_219], 0
    jne rand_init_219
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_219], eax
rand_init_219:
    mov eax, dword [var_rand_state_219]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_219]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_219], eax
    mov dword [var_rand_state_219], eax
    mov ecx, 1
    mov ebx, 100
    sub ebx, ecx
...
rand_init_230:
    ...
    add eax, ecx
    mov dword [var_stoneexchangerate], eax
    cmp dword [var_rand_state_231], 0
    jne rand_init_231
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_231], eax
rand_init_231:
    mov eax, dword [var_rand_state_231]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_231]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_231], eax
    mov dword [var_rand_state_231], eax
    mov ecx, 1
    mov ebx, 2
    sub ebx, ecx
