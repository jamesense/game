...
str_3 db 10, 0
str_4 db "Commands: 1=collect, 2=upgrade, 3=status, 4=shop, 5=achievements, 6=minigames, 7=daily reward, 8=boss fight, 9=exit ", 0
str_5 db "Lucky event! Auto collect doubled this turn.", 0
str_6 db "Forest discovery! Found %d wood.", 0
str_7 db "Quarry discovery! Found %d stone.", 0
str_8 db "Gold vein discovered! Found %d gold.", 0
str_9 db "Market boom! All resources doubled this turn.", 0
str_10 db "Enter command: ", 0
scanf_fmt_11 db "%d", 0
str_12 db "=== 1337 H4X0R M0D3 4CT1V4T3D! ===", 0
str_13 db "L33T skills detected! +337 of each resource!", 0
str_14 db "=== THE ANSWER TO LIFE, THE UNIVERSE, AND EVERYTHING! ===", 0
str_15 db "You found the meaning of life! Resources multiplied!", 0
str_16 db "=== JACKPOT! ===", 0
str_17 db "Lucky number 777! Instant level up and +77 resources!", 0
str_18 db "=== EMERGENCY RESOURCES DEPLOYED! ===", 0
str_19 db "Help is on the way! +911 resources incoming!", 0
str_20 db "=== SEQUENCE RECOGNIZED! ===", 0
str_21 db "Simple but effective! +1234 wood!", 0
str_22 db "=== BRITISH EMERGENCY! ===", 0
str_23 db "Help requested! +999 stone for sturdy structures!", 0
str_24 db "=== PI POWER! ===", 0
str_25 db "Infinite resources? Almost! +314 of everything!", 0
str_26 db "=== RESOURCE NOT FOUND ===", 0
str_27 db "Just kidding! Found hidden cache! +404 gold!", 0
str_28 db "=== IMMATURE BUT REWARDING! ===", 0
str_29 db "Heh. You know what this means. +800 resources!", 0
str_30 db "=== THAT'S THE SAME COMBINATION AS MY LUGGAGE! ===", 0
str_31 db "Spaceballs reference! +12345 total resources split evenly!", 0
str_32 db "=== PRISONER 24601! ===", 0
str_33 db "Jean Valjean would be proud! Prestige cost reduced!", 0
str_34 db "=== JENNY, I GOT YOUR NUMBER! ===", 0
str_35 db "For a good time, collect +867 resources!", 0
str_36 db "=== DECLARATION OF INDEPENDENCE! ===", 0
str_37 db "Freedom from resource scarcity! +1776 of everything!", 0
str_38 db "=== BIG BROTHER IS WATCHING ===", 0
str_39 db "Doublethink activated! Resources are both there and not there!", 0
str_40 db "=== OPEN THE POD BAY DOORS, HAL ===", 0
str_41 db "I'm sorry Dave, I'm afraid I can do that... just kidding! +2001 resources!", 0
str_42 db "=== THE TEMPLES OF SYRINX ===", 0
str_43 db "We've taken care of everything! +2112 resources!", 0
str_44 db "=== NEW WORLD DISCOVERED! ===", 0
str_45 db "You discovered new resources! +1492 of each!", 0
str_46 db "=== NORMAN CONQUEST! ===", 0
str_47 db "William the Conqueror approves! +1066 resources!", 0
str_48 db "=== NICE! ===", 0
str_49 db "Nice. +69 of everything!", 0
str_50 db "=== So wrong, resetting all ===", 0
str_51 db "=== BLAZE IT ===", 0
str_52 db "Smoke 'em if you got 'em! +420 resources!", 0
str_53 db "Nice. +67 of everything!", 0
str_54 db "Collecting resources...", 0
str_55 db "You collected %d wood.", 0
str_56 db "You collected %d stone.", 0
str_57 db "You collected %d gold.", 0
str_58 db "=== ACHIEVEMENT UNLOCKED: First Steps! ===", 0
str_59 db "Upgrading...", 0
str_60 db "Upgrade successful!", 0
str_61 db "=== ACHIEVEMENT UNLOCKED: Halfway There! (Level 5) ===", 0
str_62 db "=== ACHIEVEMENT UNLOCKED: Master Collector! (Level 10) ===", 0
str_63 db "=== ACHIEVEMENT UNLOCKED: Grand Master! (Level 20) ===", 0
str_64 db "=== ACHIEVEMENT UNLOCKED: Legendary Collector! (Level 50) ===", 0
str_65 db "=== ACHIEVEMENT UNLOCKED: Shopaholic! (Level 3+) ===", 0
str_66 db "=== ACHIEVEMENT UNLOCKED: Speedrunner! (Level 5 in <20 turns) ===", 0
str_67 db "Not enough resources for upgrade!", 0
str_68 db "Need Wood: %d, Stone: %d, Gold: %d", 0
str_69 db "=== STATUS ===", 0
str_70 db "Wood: %d", 0
str_71 db "Stone: %d", 0
str_72 db "Gold: %d", 0
str_73 db "Level: %d", 0
str_74 db "Auto Collect: %d", 0
str_75 db "Upgrade Cost: %d", 0
str_76 db "Prestige Level: %d", 0
str_77 db "Prestige Bonus: x%d", 0
str_78 db "Next Prestige Cost: %d total resources", 0
str_79 db "Next Upgrade Needs: Wood %d, Stone %d, Gold %d", 0
str_80 db "Multiplier: %d", 0
str_81 db "Achievements: %d/30", 0
str_82 db "=== SHOP ===", 0
str_83 db "1: Multiplier Boost (+1) - Cost: %d Gold", 0
str_84 db "2: Wood Cutter - Cost: %d Stone, %d Gold", 0
str_85 db "3: Stone Mason - Cost: %d Wood, %d Gold", 0
str_86 db "4: Prestige (Reset for permanent x2 bonus)", 0
str_87 db "   Cost: %d total resources", 0
str_88 db "   Current: %d/%d", 0
str_89 db "Enter choice: ", 0
scanf_fmt_90 db "%d", 0
str_91 db "Multiplier boosted!", 0
str_92 db "Not enough gold for boost!", 0
str_93 db "Wood Cutter hired! Gained %d wood.", 0
str_94 db "Need Stone: %d, Gold: %d", 0
str_95 db "Stone Mason hired! Gained %d stone.", 0
str_96 db "Need Wood: %d, Gold: %d", 0
str_97 db "PRESTIGE ACHIEVED!", 0
str_98 db "All resources converted to permanent bonus!", 0
str_99 db "Game reset with x%d production bonus!", 0
str_100 db "Not enough resources for prestige!", 0
str_101 db "Need %d total resources, you have %d", 0
str_102 db "=== ACHIEVEMENTS (%d/30) ===", 0
str_103 db "[X] First Steps - Collect your first resource", 0
str_104 db "[ ] First Steps - Collect your first resource", 0
str_105 db "[X] Halfway There - Reach Level 5", 0
str_106 db "[ ] Halfway There - Reach Level 5", 0
str_107 db "[X] Master Collector - Reach Level 10", 0
str_108 db "[ ] Master Collector - Reach Level 10", 0
str_109 db "[X] Grand Master - Reach Level 20", 0
str_110 db "[ ] Grand Master - Reach Level 20", 0
str_111 db "[X] Legendary Collector - Reach Level 50", 0
str_112 db "[ ] Legendary Collector - Reach Level 50", 0
str_113 db "[X] Resource Baron - Collect 100+ total resources", 0
str_114 db "[ ] Resource Baron - Collect 100+ total resources", 0
str_115 db "[X] Wealthy Magnate - Collect 1,000+ total resources", 0
str_116 db "[ ] Wealthy Magnate - Collect 1,000+ total resources", 0
str_117 db "[X] Resource Millionaire - Collect 10,000+ total resources", 0
str_118 db "[ ] Resource Millionaire - Collect 10,000+ total resources", 0
str_119 db "[X] Lumberjack - Collect 50+ wood", 0
str_120 db "[ ] Lumberjack - Collect 50+ wood", 0
str_121 db "[X] Quarry King - Collect 50+ stone", 0
str_122 db "[ ] Quarry King - Collect 50+ stone", 0
str_123 db "[X] Gold Digger - Collect 50+ gold", 0
str_124 db "[ ] Gold Digger - Collect 50+ gold", 0
str_125 db "[X] Wood Tycoon - Collect 500+ wood", 0
str_126 db "[ ] Wood Tycoon - Collect 500+ wood", 0
str_127 db "[X] Stone Tycoon - Collect 500+ stone", 0
str_128 db "[ ] Stone Tycoon - Collect 500+ stone", 0
str_129 db "[X] Gold Tycoon - Collect 500+ gold", 0
str_130 db "[ ] Gold Tycoon - Collect 500+ gold", 0
str_131 db "[X] Speedrunner - Reach Level 5 in under 20 turns", 0
str_132 db "[ ] Speedrunner - Reach Level 5 in under 20 turns", 0
str_133 db "[X] Shopaholic - Reach Level 3", 0
str_134 db "[ ] Shopaholic - Reach Level 3", 0
str_135 db "[X] Minigame Master - Win 10 minigames", 0
str_136 db "[ ] Minigame Master - Win 10 minigames", 0
str_137 db "[X] Event Explorer - Experience 20 random events", 0
str_138 db "[ ] Event Explorer - Experience 20 random events", 0
str_139 db "[X] Turn Veteran - Play 100 turns", 0
str_140 db "[ ] Turn Veteran - Play 100 turns", 0
str_141 db "[X] Collector Addict - Make 200 collections", 0
str_142 db "[ ] Collector Addict - Make 200 collections", 0
str_143 db "[X] Iron Fist - Reach Level 100", 0
str_144 db "[ ] Iron Fist - Reach Level 100", 0
str_145 db "[X] Collector Pro - Make 500 collections", 0
str_146 db "[ ] Collector Pro - Make 500 collections", 0
str_147 db "[X] Ultra Rich - Collect 100,000+ total resources", 0
str_148 db "[ ] Ultra Rich - Collect 100,000+ total resources", 0
str_149 db "[X] Grinder - Play 500 turns", 0
str_150 db "[ ] Grinder - Play 500 turns", 0
str_151 db "[X] Hoarder - Reach 5,000 of any resource", 0
str_152 db "[ ] Hoarder - Reach 5,000 of any resource", 0
str_153 db "[X] Unstoppable - Win 25 minigames", 0
str_154 db "[ ] Unstoppable - Win 25 minigames", 0
str_155 db "[X] Event Legend - Experience 100 random events", 0
str_156 db "[ ] Event Legend - Experience 100 random events", 0
str_157 db "[X] Jackpot - Win 15 minigames", 0
str_158 db "[ ] Jackpot - Win 15 minigames", 0
str_159 db "[X] Dedicated - Play 1,000 turns", 0
str_160 db "[ ] Dedicated - Play 1,000 turns", 0
str_161 db "[X] Maxed Out - Reach Level 200", 0
str_162 db "[ ] Maxed Out - Reach Level 200", 0
str_163 db "=== MINIGAME ARCADE ===", 0
str_164 db "Choose a minigame:", 0
str_165 db "1: Guess the Number (1-5)", 0
str_166 db "2: Card Guessing (Higher/Lower)", 0
str_167 db "3: Math Quiz", 0
str_168 db "4: Rock Paper Scissors", 0
str_169 db "Enter choice (1-4): ", 0
scanf_fmt_170 db "%d", 0
str_171 db "=== GUESS THE NUMBER MINIGAME ===", 0
str_172 db "Guess a number between 1 and 5!", 0
str_173 db "Win big rewards if you guess correctly!", 0
str_174 db "Enter your guess (1-5): ", 0
scanf_fmt_175 db "%d", 0
str_176 db "Congratulations! You guessed it!", 0
str_177 db "You won %d of each resource!", 0
str_178 db "Wrong! The number was %d", 0
str_179 db "Better luck next time!", 0
str_180 db "=== CARD GUESSING GAME ===", 0
str_181 db "Guess if the next card is HIGHER or LOWER!", 0
str_182 db "Win streak increases rewards!", 0
str_183 db "Cards are numbered 1-13", 0
str_184 db "First card: %d", 0
str_185 db "Round %d of 5", 0
str_186 db "Current streak: %d", 0
str_187 db "========================", 0
str_188 db "Current card: %d", 0
str_189 db "Guess next card:", 0
str_190 db "1 = HIGHER", 0
str_191 db " 2 = LOWER", 0
scanf_fmt_192 db "%d", 0
str_193 db "Next card: %d", 0
str_194 db "Same card! No change to streak.", 0
str_195 db "Correct! Streak: %d", 0
str_196 db "Wrong! Streak broken.", 0
str_197 db "Continue to next round?", 0
str_198 db "1 = YES", 0
str_199 db " 2 = NO (Cash out now)", 0
scanf_fmt_200 db "%d", 0
str_201 db "=== CARD GAME RESULTS ===", 0
str_202 db "Maximum Streak: %d", 0
str_203 db "Reward Multiplier: x%d", 0
str_204 db "No winning streaks this game.", 0
str_205 db "Try again for better luck!", 0
str_206 db "=== MATH QUIZ CHALLENGE ===", 0
str_207 db "Solve math problems for bonuses!", 0
str_208 db "Difficulty increases with your level!", 0
str_209 db "--- Question %d of %d ---", 0
str_210 db "What is %d + %d?", 0
str_211 db "What is %d - %d?", 0
str_212 db "What is %d * %d?", 0
str_213 db "What is %d / %d?", 0
str_214 db "Enter your answer: ", 0
scanf_fmt_215 db "%d", 0
str_216 db "Correct! +1 point", 0
str_217 db "Wrong! The answer was %d", 0
str_218 db "Quiz Complete! Score: %d/%d", 0
str_219 db "Quiz Complete! Score: 0/%d", 0
str_220 db "Study up and try again!", 0
str_221 db "=== ROCK PAPER SCISSORS ===", 0
str_222 db "Best of 3 rounds!", 0
str_223 db "1 = ROCK (beats scissors)", 0
str_224 db " 2 = PAPER (beats rock)", 0
str_225 db " 3 = SCISSORS (beats paper)", 0
str_226 db "Win all 3 rounds for maximum reward!", 0
str_227 db "===========================", 0
str_228 db "--- Round %d ---", 0
str_229 db "Choose: 1=Rock, 2=Paper, 3=Scissors", 0
str_230 db "Your choice: ", 0
scanf_fmt_231 db "%d", 0
str_232 db "You chose: ", 0
str_233 db "ROCK", 0
str_234 db "PAPER", 0
str_235 db "SCISSORS", 0
str_236 db "Bot chose: ", 0
str_237 db "It's a TIE!", 0
str_238 db "Replaying round...", 0
str_239 db "You WIN this round!", 0
str_240 db "Bot WINS this round!", 0
str_241 db "Score: You %d - %d Bot", 0
str_242 db "=== ROCK PAPER SCISSORS RESULTS ===", 0
str_243 db "Final Score: You %d - %d Bot", 0
str_244 db "PERFECT VICTORY! 3-0 SWEEP!", 0
str_245 db "JACKPOT! You won %d of each resource!", 0
str_246 db "VICTORY! You beat the bot!", 0
str_247 db "Close match! You won!", 0
str_248 db "DRAW! No winner this time.", 0
str_249 db "Consolation prize: %d of each resource", 0
str_250 db "DEFEAT! The bot was too strong!", 0
str_251 db "Participation reward: %d of each resource", 0
str_252 db "+%d wood", 0
str_253 db "+%d stone", 0
str_254 db "+%d gold", 0
str_255 db "Daily reward collected!", 0
str_256 db "Daily reward already collected.", 0
str_257 db "No boss right now.", 0
str_258 db "You deal %d damage!", 0
str_259 db "Boss defeated! Massive resource drop!", 0
str_260 db "Boss HP: %d", 0
str_261 db "Exiting game...", 0
str_262 db "Total Resources: %d", 0
str_263 db "Turns Played: %d", 0
str_264 db "Collections Made: %d", 0
str_265 db "=== ACHIEVEMENT UNLOCKED: Resource Baron! (100+ total resources) ===", 0
str_266 db "=== ACHIEVEMENT UNLOCKED: Wealthy Magnate! (1,000+ total resources) ===", 0
str_267 db "=== ACHIEVEMENT UNLOCKED: Resource Millionaire! (10,000+ total resources) ===", 0
str_268 db "=== ACHIEVEMENT UNLOCKED: Lumberjack! (50+ wood) ===", 0
str_269 db "=== ACHIEVEMENT UNLOCKED: Quarry King! (50+ stone) ===", 0
str_270 db "=== ACHIEVEMENT UNLOCKED: Gold Digger! (50+ gold) ===", 0
str_271 db "=== ACHIEVEMENT UNLOCKED: Wood Tycoon! (500+ wood) ===", 0
str_272 db "=== ACHIEVEMENT UNLOCKED: Stone Tycoon! (500+ stone) ===", 0
str_273 db "=== ACHIEVEMENT UNLOCKED: Gold Tycoon! (500+ gold) ===", 0
str_274 db "=== ACHIEVEMENT UNLOCKED: Minigame Master! (10 minigame wins) ===", 0
str_275 db "=== ACHIEVEMENT UNLOCKED: Event Explorer! (20 random events) ===", 0
str_276 db "=== ACHIEVEMENT UNLOCKED: Turn Veteran! (100 turns played) ===", 0
str_277 db "=== ACHIEVEMENT UNLOCKED: Collector Addict! (200 collections made) ===", 0
str_278 db "=== ACHIEVEMENT UNLOCKED: Iron Fist! (Level 100) ===", 0
str_279 db "=== ACHIEVEMENT UNLOCKED: Collector Pro! (500 collections) ===", 0
str_280 db "=== ACHIEVEMENT UNLOCKED: Ultra Rich! (100,000+ total resources) ===", 0
str_281 db "=== ACHIEVEMENT UNLOCKED: Grinder! (500 turns played) ===", 0
str_282 db "=== ACHIEVEMENT UNLOCKED: Hoarder! (5,000+ of a resource) ===", 0
str_283 db "=== ACHIEVEMENT UNLOCKED: Unstoppable! (25 minigame wins) ===", 0
str_284 db "=== ACHIEVEMENT UNLOCKED: Event Legend! (100 random events) ===", 0
str_285 db "=== ACHIEVEMENT UNLOCKED: Jackpot! (15 minigame wins) ===", 0
str_286 db "=== ACHIEVEMENT UNLOCKED: Dedicated! (1,000 turns played) ===", 0
str_287 db "=== ACHIEVEMENT UNLOCKED: Maxed Out! (Level 200) ===", 0
cmd_288 db "cls", 0
str_289 db "Turn: %d", 0
str_290 db "Auto Collect Rate: %d", 0
str_291 db "Prestige: Level %d (x%d bonus)", 0
str_292 db "A wild RESOURCE GOLEM appears!", 0
...
if_then_117:
    ...
    call _printf
    add esp, 4
    cmp dword [var_rand_state_118], 0
    jne rand_init_118
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_118], eax
rand_init_118:
    mov eax, dword [var_rand_state_118]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_118]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_118], eax
    mov dword [var_rand_state_118], eax
    mov ecx, 1
    mov ebx, 5
    sub ebx, ecx
...
while_start_122:
    ...
    call _printf
    add esp, 4
    cmp dword [var_rand_state_123], 0
    jne rand_init_123
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_123], eax
rand_init_123:
    mov eax, dword [var_rand_state_123]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_123]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_123], eax
    mov dword [var_rand_state_123], eax
    mov ecx, 1
    mov ebx, 13
    sub ebx, ecx
...
rand_init_139:
    ...
    cmp dword [var_rand_state_140], 0
    jne rand_init_140
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_140], eax
rand_init_140:
    mov eax, dword [var_rand_state_140]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_140]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_140], eax
    mov dword [var_rand_state_140], eax
    mov ecx, 1
    mov ebx, dword [var_maxnumber]
    sub ebx, ecx
...
if_end_153:
    ...
    call _time
    add esp, 4
    mov dword [var_rand_state_154], eax
rand_init_154:
    mov eax, dword [var_rand_state_154]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_154]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_154], eax
    mov dword [var_rand_state_154], eax
    mov ecx, 1
    mov ebx, 3
    sub ebx, ecx
