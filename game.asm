...
var_rand_state_131 resd 1
var_guess resd 1
var_reward resd 1
var_currentcard resd 1
var_rand_state_134 resd 1
var_streak resd 1
var_maxstreak resd 1
var_round resd 1
var_playerguess resd 1
var_nextcard resd 1
var_rand_state_136 resd 1
var_correct resd 1
var_continue resd 1
...
var_compdie2 resd 1
var_rand_state_196 resd 1
var_comptotal resd 1
var_playerdoubles resd 1
var_compdoubles resd 1
var_loss resd 1
var_coin resd 1
var_rand_state_210 resd 1
var_score resd 1
var_currentnum resd 1
var_rand_state_214 resd 1
var_nextnum resd 1
var_rand_state_216 resd 1
var_canplay resd 1
var_reel1 resd 1
...
var_rand_state_265 resd 1
var_baseamount resd 1
var_woodrate resd 1
var_stonerate resd 1
var_goldrate resd 1
...
if_then_38:
    ...
    call _time
    add esp, 4
    mov dword [var_rand_state_39], eax
rand_init_39:
    mov eax, dword [var_rand_state_39]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_39]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_39], eax
    mov dword [var_rand_state_39], eax
    mov ecx, 1
    mov ebx, 3
    sub ebx, ecx
...
if_then_130:
    ...
    call _time
    add esp, 4
    mov dword [var_rand_state_131], eax
rand_init_131:
    mov eax, dword [var_rand_state_131]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_131]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_131], eax
    mov dword [var_rand_state_131], eax
    mov ecx, 1
    mov ebx, 5
    sub ebx, ecx
...
if_then_133:
    ...
    mov eax, ebx
    mov dword [var_minigameplays], eax
    cmp dword [var_rand_state_134], 0
    jne rand_init_134
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_134], eax
rand_init_134:
    mov eax, dword [var_rand_state_134]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_134]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_134], eax
    mov dword [var_rand_state_134], eax
    mov ecx, 1
    mov ebx, 13
    sub ebx, ecx
...
while_start_135:
    ...
    call _printf
    add esp, 4
    cmp dword [var_rand_state_136], 0
    jne rand_init_136
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_136], eax
rand_init_136:
    mov eax, dword [var_rand_state_136]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_136]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_136], eax
    mov dword [var_rand_state_136], eax
    mov ecx, 1
    mov ebx, 13
    sub ebx, ecx
...
rand_init_154:
    ...
    jmp if_else_155
if_then_155:
    cmp dword [var_rand_state_156], 0
    jne rand_init_156
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_156], eax
rand_init_156:
    mov eax, dword [var_rand_state_156]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_156]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_156], eax
    mov dword [var_rand_state_156], eax
    mov ecx, 1
    mov ebx, 10
    sub ebx, ecx
...
if_end_166:
    ...
    call _time
    add esp, 4
    mov dword [var_rand_state_167], eax
rand_init_167:
    mov eax, dword [var_rand_state_167]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_167]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_167], eax
    mov dword [var_rand_state_167], eax
    mov ecx, 1
    mov ebx, 3
    sub ebx, ecx
...
rand_init_195:
    ...
    cmp dword [var_rand_state_196], 0
    jne rand_init_196
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_196], eax
rand_init_196:
    mov eax, dword [var_rand_state_196]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_196]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_196], eax
    mov dword [var_rand_state_196], eax
    mov ecx, 1
    mov ebx, 6
    sub ebx, ecx
...
if_then_209:
    ...
    call _time
    add esp, 4
    mov dword [var_rand_state_210], eax
rand_init_210:
    mov eax, dword [var_rand_state_210]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_210]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_210], eax
    mov dword [var_rand_state_210], eax
    mov ecx, 1
    mov ebx, 2
    sub ebx, ecx
...
if_then_213:
    ...
    cmp dword [var_rand_state_214], 0
    jne rand_init_214
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_214], eax
rand_init_214:
    mov eax, dword [var_rand_state_214]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_214]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_214], eax
    mov dword [var_rand_state_214], eax
    mov ecx, 1
    mov ebx, 10
    sub ebx, ecx
...
while_start_215:
    ...
    call _time
    add esp, 4
    mov dword [var_rand_state_216], eax
rand_init_216:
    mov eax, dword [var_rand_state_216]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_216]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_216], eax
    mov dword [var_rand_state_216], eax
    mov ecx, 1
    mov ebx, 10
    sub ebx, ecx
...
rand_init_264:
    ...
    cmp dword [var_rand_state_265], 0
    jne rand_init_265
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_265], eax
rand_init_265:
    mov eax, dword [var_rand_state_265]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_265]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_265], eax
    mov dword [var_rand_state_265], eax
    mov ecx, 1
    mov ebx, 2
    sub ebx, ecx
...
if_then_277:
    ...
    cmp dword [var_rand_state_278], 0
    jne rand_init_278
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_278], eax
rand_init_278:
    mov eax, dword [var_rand_state_278]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_278]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_278], eax
    mov dword [var_rand_state_278], eax
    mov ecx, 1
    mov ebx, 3
    sub ebx, ecx
...
if_end_292:
    ...
    jmp if_else_294
if_then_294:
    cmp dword [var_rand_state_295], 0
    jne rand_init_295
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_295], eax
rand_init_295:
    mov eax, dword [var_rand_state_295]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_295]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_295], eax
    mov dword [var_rand_state_295], eax
    mov ecx, 1
    mov ebx, 100
    sub ebx, ecx
...
rand_init_306:
    ...
    add eax, ecx
    mov dword [var_stoneexchangerate], eax
    cmp dword [var_rand_state_307], 0
    jne rand_init_307
    push 0
    call _time
    add esp, 4
    mov dword [var_rand_state_307], eax
rand_init_307:
    mov eax, dword [var_rand_state_307]
    xor eax, eax
    rdtsc
    xor edx, edx
    mov ecx, dword [var_rand_state_307]
    add eax, ecx
    rol eax, 7
    add dword [var_rand_state_307], eax
    mov dword [var_rand_state_307], eax
    mov ecx, 1
    mov ebx, 2
    sub ebx, ecx
